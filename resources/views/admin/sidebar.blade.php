		...
		<div class="wrapper" style="margin-bottom:90px">
			<ul class="nav nav-sidebar" id="sidebar-menu">
               ...
               @if(Auth::user()->usertype=='Admin')
	                ...
	                <li class="{{classActivePath('types')}}"><a href="{{ URL::to('admin/types') }}"><i class="fa fa-tags"></i>Venue Types</a></li>
	                
	                <li class="{{classActivePath('properties')}}"><a href="{{ URL::to('admin/properties') }}"><i class="md md-pin-drop"></i>Venues</a></li>
...
<!--<li class="{{classActivePath('partners')}}"><a href="{{ URL::to('admin/partners') }}"><i class="fa fa-bookmark-o"></i>Partners</a></li>
		...
		-->			<li class="{{classActivePath('cities')}}"><a href="{{ URL::to('admin/cities') }}"><i class="md md-location-city"></i>Cities</a></li>
	            ...
	            @elseif(Auth::user()->usertype=='Client')
               		 ...
               		 <li class="{{classActivePath('payments')}}"><a href="{{ URL::to('admin/payments') }}"><i class="md md-send"></i>Payments</a></li>
               	...
               	@elseif	(Auth::user()->usertype=='Owner')	
					...
					<li class="{{classActivePath('dashboard')}}"><a href="{{ URL::to('admin/dashboard') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
               		...
               		<li class="{{classActivePath('properties')}}"><a href="{{ URL::to('admin/properties') }}"><i class="md md-pin-drop"></i>Farms</a></li>
