        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1 col-sm-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="{{ URL::to('properties/') }}">Venues</a></li> 
                  ...
                  <div class="tab-pane fade in active" id="detail">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <h5>"By clicking the button,you agree to OEMS <a href="{{ URL::to('terms-conditions')}}">Terms & Conditions</a>" </h5>
                 <br/>
                 @if(Auth::check())
                  <form action="{{ URL::to('admin/properties/contract',$property->id) }}">
                    <div class="form-group col-md-4">
                      <label for="date">Choose Event Date:</label>
                      <input type="text" class="form-control" id="datepicker" name="eventdate">
                      <input type="hidden" name="proid" value="{{ $property->id }}">
                    </div>
                 
                    <button type="submit" class="signup">Reserve</button>
                  </form>                   
                                
                 @else                    

                <a href="{{ URL::to('login')  }}" class="signup">Reserve</a>
                  @endif
                @if($property->eventdate != '')
                <h4 style="color:red">Note: Venue is already booked for {{$property->eventdate}}</h4>
                @endif               
